                    ...
                    <div className="nine columns main-col">
                        <div className="row item">
                            <div className="twelve columns">
                                ...
                                <p className="info"> Administrador de Base de Datos <span>•</span>{" "}<em className="date">Febrero 2020 - Present</em></p>
                                <p>
                        ...
                        <div className="row item">
                            <div className="twelve columns">
                                <h3>Pale Consultores</h3>
                                <p className="info">Help Desk <span>•</span>{" "}<em className="date">Marzo 2019 - Enero 2020</em></p>
                                <p>Brindar soluciones a nivel 1 en forma remota a clientes de rubros mineros, supermercados, grifos y hoteles con sistema de facturacion electronica con prioridad de resolver sus problemas con el sistema de facturacion.</p>
                            </div>
                        </div>
                    </div>
                </div>
